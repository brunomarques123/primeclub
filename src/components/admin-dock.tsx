...
const ITENS = [
  { href: "/admin/empresas", label: "Empresas", icone: "🏬" },
  { href: "/admin/moderacao", label: "Moderação", icone: "🛡️" },
  { href: "/admin/validar-cupom", label: "Validar", icone: "🎟️" },
  { href: "/admin/metricas", label: "Métricas", icone: "📊" },
];
